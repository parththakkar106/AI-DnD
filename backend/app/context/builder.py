...
def build_context(
    ...
    # `story_summary` is a property that returns the version belonging to the
    # story being played, not a column. Reading the property rather than
    # importing `app.summaries` also keeps this package free of an import back
    # into the app, which `app.summaries` imports from. See `app/summaries.py`.
